...
QT_MOC_LITERAL(3, 29, 4) // "data"
    ...
    "ReceiverThread\0dataReceived\0\0data"
};
...
void ReceiverThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReceiverThread::dataReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ReceiverThread::dataReceived(const QString & _t1)
{
